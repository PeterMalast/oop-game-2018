...
import sk.tuke.kpi.oop.game.vlastne.AlienWizard;
import sk.tuke.kpi.oop.game.vlastne.Boss;
        ...
        new Loop<>(
            new Invoke<>(() -> {
                for (Actor actor : scene.getActors()) {
                    if ((this.intersects(actor)) && ((actor instanceof Alien) || (actor instanceof AlienWizard) || (actor instanceof Boss)) ) {
